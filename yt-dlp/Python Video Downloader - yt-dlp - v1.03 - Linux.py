...
def errorHandler(error, uri):
    ...
    # Tweet cannot be found OR cookies need to be passed since Twitter now requires an account to view tweets.
...
if platform.system() == "Linux":
    cookie = ('firefox', 'zzgbjldv.default-release', None, 'userContextPersonal.label')
elif platform.system() == "Windows":
