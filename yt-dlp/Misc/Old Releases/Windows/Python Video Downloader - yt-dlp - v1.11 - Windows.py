""" 
    ...
    Updates:
        ...
        * Hotfix:
            * Chrome no longer allows outside access to cookies, we let the user know that they must either:
                * Switch to Linux
                * Switch to Firefox
                * Download an extension, create a cookies.txt file, and figure out how to pass it to yt-dlp with Python
"""
...
def title():
    ...
    title = "[Python Video Downloader.py v1.11 - 'The best downloader in town!']"
